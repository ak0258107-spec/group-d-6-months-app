const CACHE="gk-purushotam-cbt-poster-v14-2-final";
const ASSETS=[
  ...
  "./styles.css","./simple-v1220.css","./config.js","./common.js","./student-final-v14.js","./admin-final-v14.js","./avatar-boy.svg","./avatar-girl.svg","./avatar-student.svg",
  "./manifest.json","./manifest.webmanifest","./favicon.png","./apple-touch-icon.png","./icon-192.png","./icon-512.png",
  "./cbt-mock-test.css","./cbt-admin.html","./cbt-admin-final-v14.js","./cbt-exam-v12-26.html","./cbt-student-v12-26.js","./cbt-final-v13.js","./cbt-topics-data.js","./cbt-logo.webp","./cbt-preview-banner.png"
];
