...
const FINAL_RESUME_PREFIX='CBT_FINAL_V13_RESUME_';
...
startTest=async function(){
 ...
 const btn=byId('startTestBtn');try{
   ...
   if(series){
     ...
     if(questions.length!==Number(series.question_count))throw new Error('Fixed Test Set incomplete है। Admin से series दोबारा Generate करें।');
     ...
     finalBeginQuestions(questions,setup);
     setTimeout(()=>alert('इस selection का Fixed Test Series अभी Admin ने Generate नहीं किया है। यह attempt Practice mode में चलेगा और Official Rank नहीं बनेगी।'),80);
   }
