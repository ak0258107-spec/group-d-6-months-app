const CACHE="gk-purushotam-premium-v15-final";
const ASSETS=[
  ...
  "./styles.css","./simple-v1220.css","./config.js","./common.js","./student-final-v15.js","./admin-final-v15.js","./avatar-boy.svg","./avatar-girl.svg","./avatar-student.svg",
  "./manifest.json","./manifest.webmanifest","./favicon.png","./apple-touch-icon.png","./icon-192.png","./icon-512.png",
  "./cbt-mock-test.css","./cbt-admin.html","./cbt-admin-final-v15.js","./cbt-exam-v12-26.html","./cbt-student-v12-26.js","./cbt-final-v15.js","./cbt-topics-data.js","./cbt-logo.webp","./cbt-preview-banner.png","./VERSION_FINAL_V15.json"
];
...
self.addEventListener('push',event=>{
  ...
  const options={body:data.message||'नई जानकारी उपलब्ध है।',icon:'./icon-192.png',badge:'./favicon.png',tag:data.tag||'gk-update',renotify:true,requireInteraction:false,data:{url:data.url||'./l4x8m2r7-k9v3t5n1-z6c4p8q2.html?tab=home',notificationId:data.notificationId||null}};
...
self.addEventListener('notificationclick',event=>{
  ...
  const raw=event.notification?.data?.url||'./l4x8m2r7-k9v3t5n1-z6c4p8q2.html?tab=home';
